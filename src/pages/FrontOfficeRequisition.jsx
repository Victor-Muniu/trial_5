...
function FrontOfficeRequisition() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await axios.get('https://hotel-backend-1-trhj.onrender.com/frontOfficeRequisitions');
  ...
  const handleApprove = async (row) => {
    ...
    try {
      ...
      const response = await axios.patch(`https://hotel-backend-1-trhj.onrender.com/frontOfficeRequisitions/${row._id}`, patchData);
...
export default FrontOfficeRequisition;
